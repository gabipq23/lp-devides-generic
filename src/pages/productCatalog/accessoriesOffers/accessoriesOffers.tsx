...
import { useAccessoriesOffersController } from "./controller";

function AccessoriesOffers() {
  const {
  ...
  } = useAccessoriesOffersController();
                          ...
                          <img
                            src={
                              product.model === "Roteador Askey Wifi 5G"
                                ...
                                : product.model ===
                                  "Vivo Box Internet 4G BCMG718"
                                  ? isProductVivoBoxIMG
                                  : product.model ===
                                    "Relógio Samsung Watch7 (Galaxy Watch 7 Classic LTE 44mm) – 4G"
                                    ? isProductRelógioSamsungWatch7IMG
                                    : product.model ===
                                      "Tablet Samsung X616 (Galaxy Tab S9 FE+ 5G)"
...
export default AccessoriesOffers;
